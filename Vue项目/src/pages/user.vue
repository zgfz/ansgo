<template>
	<div class="user">
		...
		<div class="user_top">
			...
			<p class="p2">
				<a href="javascript:;" class="right"><span><i>昵称</i>&nbsp;/&nbsp;<s @click="logout">注销</s></span></a>
			</p>
		</div>
...
<style scoped>
	...
	.user .user_top .p2 a{color:#fff;font-size:0.25rem;font-weight: 700;}
	.user .user_top .p2 a i{}
	.user .user_top .p2 a s{text-decoration: none;}
